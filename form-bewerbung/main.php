...
$messagetext = 'Es wurde eine Nachricht abgeschickt!<br />
    ...
    <strong>Vorname</strong>: '.$_POST["vorname"].'<br>
    <strong>Nachname</strong>: '.$_POST["nachname"].'<br>
    <strong>Telefon</strong>: '.$_POST["tel"].'<br>
    <strong>E-Mail</strong>: '.$_POST["mail"].'<br>
    <strong>Straße</strong>: '.$_POST["adresse"].'<br>
    <strong>Ort</strong>: '.$_POST["plz"].'<br>
    <br>';
...
$title = 'Bewerbung von ' . wp_strip_all_tags($_POST['vorname']) . ' | ' . wp_strip_all_tags($_POST['mail']);
$my_post = array(
 ...
 * 
 */
mail::wp_htmlmail('j.wigger@moleco.de', 'Es wurde eine Bewerbung über moleco.de geschickt', $messagetext, 'Moleco GmbH', 'noreply@moleco.de', $attachments);
