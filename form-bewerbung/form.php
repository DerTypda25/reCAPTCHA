<form id="<!-- Indivieduelle ID -->" class="ajaxForm" enctype="multipart/form-data" method="post">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <p>
                    <label>Wie bist Du auf die MOLECO GmbH aufmerksam geworden?
                        <select id="select" name="select">
                            <option value="Social Media">Social Media</option>
                            <option value="Website">Website</option>
                            <option value="Online-Jobbörsen">Online-Jobbörsen</option>
            ...
            <div class="col-6">
                <p>
                    <label><span>Bitte lade hier Deine Unterlagen hoch</span><span>Markiere beim Durchsuchen Deines Computers mit "STRG" mehrere Dateien für den Upload (Multiauswahl).</span>
...
$("form.ajaxForm").submit(function(e) {
    ...
    if(solved == 'true'){
        ...
        $.ajax({
            url: '<?php echo get_stylesheet_directory_uri(); ?>/include/form-bewerbung/main.php',
            type: 'post',
            data: formData,
            processData: false,
            contentType: false,
