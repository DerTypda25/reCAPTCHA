...
class mail {
    ...
    static public function getmailtemplate($betreff,$message,$from,$logoURL = "",$preheader = ""){
        $mailbody = '
        <html>
            <head>
                ...
                <style>
                    ...
                    p,
                    ul,
                    ol {font-family: sans-serif;font-size: 14px;font-weight: normal;margin: 0;margin-bottom: 15px; }
                    p li,
                    ul li,
                    ...
                    table.body td,
                    table.body span,
                    table.body a {font-size: 16px !important; }
                    table.body .wrapper,
                    table.body .article {padding: 10px !important; }
                ...
                <td class="container">
                    ...
                    <table role="presentation" class="main">
                        ...
                        <td class="wrapper">
                            ...
                            <tr>
                                <td>
                                    <p><img src="'.$logoURL.'" alt="logo" class="logo"></p>
                                    <p>'.$message.'</p>
                                    <p>Mit freundlichen Grüßen<br/>'.$from.'</p>
                                </td>
                            </tr>
                            </table>
                        </td>
     ...
     * 
     */
    static public function wp_htmlmail($empfaenger,$betreff,$nachricht,$from,$replyto,$attachments = array()){

        $logoURL = "";
        $preheader = "";

        $mailbody = mail::getmailtemplate($betreff,$nachricht,$from,$logoURL,$preheader);

        $header = "From: ".$from." <".$replyto.">\n";
        $header .= "Reply-To: ".$replyto."\n";
        $header .= "Content-Type: text/html\n";
        wp_mail( $empfaenger,$betreff,$mailbody,$header, $attachments );
    }
